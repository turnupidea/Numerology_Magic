...
public class CompanyName extends AppCompatActivity
{
    ...
    TextView companyName_bestDay;
    TextView companyName_bestMonth;
    TextView companyName_bestTime;
    TextView companyName_result;
    Button button_companyName;
    EditText edit_companyName;
    TextView home_text, karmicNumber_CompanyName;
    ImageView settings, question;
    ImageView toolbar_Back_companyName;
    RelativeLayout relativeLayout;
    ImageView companyName_displayResult ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.companyname);

        relativeLayout = (RelativeLayout) findViewById(R.id.CompanyName);
        companyName_displayResult = (ImageView) findViewById(R.id.companyName_displayResult);

        question = (ImageView) findViewById(R.id.companyName_question);
        ...
        home_text = (TextView) findViewById(R.id.companyName_text);
        ...
        karmicNumber_CompanyName = (TextView) findViewById(R.id.home_text_karmicNo_companyName);
        SharedPreferences example1 = getSharedPreferences(PREFS, 0);
        String userString1 = example1.getString("userMessage1","");
        karmicNumber_CompanyName.setText(userString1);
        ...
        settings = (ImageView) findViewById(R.id.companyName_setting);
        settings.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (android.os.Build.VERSION.SDK_INT >= 19)
                {
                    final String[] listItems = new String[]{"English", "हिंदी", "मराठी"};
                    AlertDialog.Builder mBuilder = new AlertDialog.Builder(CompanyName.this);
        ...
        companyName_result = (TextView) findViewById(R.id.companyName_result);
        companyName_bestDay = (TextView) findViewById(R.id.companyName_bestday);
        companyName_bestMonth = (TextView) findViewById(R.id.companyName_bestmonth);
        companyName_bestTime = (TextView) findViewById(R.id.companyName_besttime);
        edit_companyName = (EditText) findViewById(R.id.edit1_companyName);
        toolbar_Back_companyName = (ImageView) findViewById(R.id.back_companyName);
        toolbar_Back_companyName.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View v)
            {
                Intent intent = new Intent(CompanyName.this,Home.class);
        ...
        final String mulank = karmicNumber_CompanyName.getText().toString();

        button_companyName = (Button) findViewById(R.id.button1_companyName);

        if (bhagyank.isEmpty() || mulank.isEmpty())
        {
            button_companyName.setEnabled(false);
            ...
            }).setActionTextColor(ContextCompat.getColor(CompanyName.this, R.color.textColor));
            snackbar.show();

            View snackView = snackbar.getView();
            TextView textView = snackView.findViewById(android.support.design.R.id.snackbar_text);
            textView.setTextColor(ContextCompat.getColor(CompanyName.this, R.color.textColor));
            textView.setTypeface( textView.getTypeface(), Typeface.BOLD);
        }

        button_companyName.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
                ...
                int result,i;
                result = 0;
                str1 = edit_companyName.getEditableText().toString();

                if (TextUtils.isEmpty(str1))
                {
                    Toast.makeText(CompanyName.this,"Enter Company Name",Toast.LENGTH_SHORT).show();
                }
                ...
                companyName_result.setText(String.valueOf(sum));

                String sumResult = companyName_result.getText().toString();

                if (sumResult.equals(home_text.getText().toString()) )
                {
                    companyName_bestDay.setText(R.string.companyName_result_Lucky);
                    companyName_displayResult.setImageResource(R.drawable.best);
                }

                else if (sumResult.equals(karmicNumber_CompanyName.getText().toString()))
                {
                    companyName_bestDay.setText(R.string.companyName_result_Mulank);
                    companyName_displayResult.setImageResource(R.drawable.good);
                }

                else
                {
                    companyName_bestDay.setText(R.string.companyName_result_Bad);
                    companyName_displayResult.setImageResource(R.drawable.bad);
                }
            }
        });
    }
